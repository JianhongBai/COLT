...
parser.add_argument('--dataset', default='places365', type=str)
...
if args.dataset == 'imagenet' or args.dataset == 'imagenet-100' or args.dataset == 'places365':
  # setup data loader
...
if args.dataset == 'imagenet':
  ...
  txt_train = "split/places365/Places_LT_train.txt"
  txt_val = "split/places365/Places_LT_val.txt"
  txt_test = "split/places365/Places_LT_test.txt"
else:
  assert False
...
if args.fullset:
  if args.dataset == 'imagenet':
    ...
    txt_train = "split/places365/Places_train.txt"
  else:
    assert False
...
if args.customSplit != '':
  if args.dataset == 'imagenet':
    ...
    txt_train = "split/places365/{}.txt".format(args.customSplit)
  else:
    assert False
...
def main():
  ...
  imagenet = args.dataset == 'imagenet' or args.dataset == 'imagenet-100' or args.dataset == 'places365'
  if args.model == 'res18':
